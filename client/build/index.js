...
var getPhongMaterialFromTexture = (texture, color = 16777215) => {
  return new MeshPhongMaterial({ color, map: texture });
};
var generateDirectionalLight = (color = 16777215, intensity = 0.5) => {
  const directionalLight = new DirectionalLight(color, intensity);
  directionalLight.position.set(1, 1, 1);
  directionalLight.target.position.set(0, 0, 0);
  return directionalLight;
};
var generateAmbientLight = (color = 4210752) => {
  return new AmbientLight(color);
};
var textures = {
  ian: new TextureLoader().load("/assets/ian.jpg")
};
var geometries = {
...
var sceneElements = {
  ...
  objects: {
    cube: new Mesh(geometries.box, getPhongMaterialFromTexture(textures.ian))
  }
};
var scene = new Scene;
...
Object.values(sceneElements).forEach((element) => {
  Object.values(element).forEach((element2) => scene.add(element2));
});
animate();
